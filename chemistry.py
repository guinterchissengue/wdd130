...
Program: Chemistry.py

Enhancement:
The software calculates the atom count in every chemical compound in one molecule of the given chemical formula.
'''
...
def make_periodic_table():
    '''Create and return a dictionary of all elements in the periodic table.
    Key = element symbol, Value = [name, atomic mass]
    '''
    return {
        'Ac': ['Actinium', 227],
        'Ag': ['Silver', 107.8682],
...
def main():
    ...
    # Enhancement
    total_atoms = sum(quantity for symbol, quantity in symbol_quantity_list)
    print(f'Total number of atoms in one molecule: {total_atoms}')
